...
var _default = exports.default = new (_plugin().Transformer)({
  async loadConfig({
    ...
    if (config.isSource) {
      ...
      if ((compilerOptions === null || compilerOptions === void 0 ? void 0 : compilerOptions.jsx) === 'react-jsx' || (compilerOptions === null || compilerOptions === void 0 ? void 0 : compilerOptions.jsx) === 'react-jsxdev' || compilerOptions !== null && compilerOptions !== void 0 && compilerOptions.jsxImportSource) {
        ...
        var _pkg$dependencies3, _pkg$devDependencies3, _pkg$peerDependencies3;
        ...
        if (effectiveReactLib === 'react' && reactLibVersion === 'canary') {
          ...
          var _JSX_PRAGMA$effective, _semver$minVersion;
  ...
  async transform({
    ...
    let {
      ...
      inline_fs: Boolean(config === null || config === void 0 ? void 0 : config.inlineFS),
    ...
    if (asset.type === 'mdx') {
      ...
      for (let [i, mdxAsset] of mdx_assets.entries()) {
        ...
        if (asset.env.sourceMap && mdxAsset.position) {
          ...
          for (let i = mdxAsset.position.start.line + 1; i < mdxAsset.position.end.line; i++) {
            mappings.push({
              generated: {
                line,
                column: 0
    ...
    for (let dep of dependencies) {
      if (dep.kind === 'WebWorker') {
        ...
        var _dep$attributes, _dep$attributes2;
        let meta = {
          kind: dep.kind
        };
        if (dep.attributes) {
        ...
        let isHelper = dep.flags & HELPER && !(dep.specifier.endsWith('/jsx-runtime') || dep.specifier.endsWith('/jsx-dev-runtime'));
        ...
        if (((_dep$attributes = dep.attributes) === null || _dep$attributes === void 0 ? void 0 : _dep$attributes.env) === 'react-server') {
          env = {
            ...env,
            context: 'react-server',
            outputFormat: 'commonjs'
          };
        } else if (((_dep$attributes2 = dep.attributes) === null || _dep$attributes2 === void 0 ? void 0 : _dep$attributes2.env) === 'react-client') {
          env = {
            ...env,
            context: 'react-client',
            outputFormat: 'esmodule',
