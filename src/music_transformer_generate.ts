...
export type GenerationProgressCallback = (generated: number, total: number) => void;
 ...
 */
export async function* chunkGenerator(chat: ChatInterface,
  musicLogitProcessor: MusicLogitProcessor,
  callback: GenerationProgressCallback): AsyncGenerator<Array<number>, void, void> {
  ...
  while (true) {  // TODO: change to a user-triggered stop
